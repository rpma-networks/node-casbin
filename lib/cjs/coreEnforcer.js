...
class CoreEnforcer {
  ...
  privateEnforce(asyncCompile = true, ...rvals) {
    ...
    return __awaiter(this, void 0, void 0, function*() {
      ...
      const expString =
        (_b = (_a = this.model.model.get('m')) === null || _a === void 0 ? void 0 : _a.get('m')) === null || _b === void 0
          ? void 0
          : _b.value;
      if (!expString) {
      ...
      const effectExpr =
        (_d = (_c = this.model.model.get('e')) === null || _c === void 0 ? void 0 : _c.get('e')) === null || _d === void 0
          ? void 0
          : _d.value;
      if (!effectExpr) {
      ...
      const rTokens =
        (_h = (_g = this.model.model.get('r')) === null || _g === void 0 ? void 0 : _g.get('r')) === null || _h === void 0
          ? void 0
          : _h.tokens;
      ...
      if (policyLen && policyLen !== 0) {
        ...
        const parameters = {};
        rTokens === null || rTokens === void 0
          ? void 0
          : rTokens.forEach((token, j) => {
              parameters[token] = rvals[j];
            });
        (_j = p === null || p === void 0 ? void 0 : p.tokens) === null || _j === void 0
          ? void 0
          : _j.forEach(token => {
              parameters[token] = '';
            });
